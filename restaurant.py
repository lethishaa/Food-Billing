...
root.title("Food Billing")      # Title is set
...
Tops.configure(background='ivory')
f1.configure(background='ivory')
f2.configure(background='ivory')

# =========================================== Label Set on Top to Restaurant MS =================================

lblInfo = Label(Tops, font=('arial', 64, 'bold'), text="Food Billing", bd=9)
...
def Receipt():
    ...
    'Items\t\t\t\t\t\t' + "Cost of Items \n\n"
    'Fries:\t\t\t\t\t\t\t' + E_Fries.get() + "\n"
    'Lunch Meal: \t\t\t\t\t\t' + E_Lunch.get() + "\n"
    'Burger: \t\t\t\t\t\t' + E_Burger.get() + "\n"
    'Pizza: \t\t\t\t\t\t\t' + E_Pizza.get() + "\n"
    'Cheese Burger: \t\t\t\t\t\t' + E_CheeseBurger.get() + "\n"
    'Mac Nuggets: \t\t\t\t\t\t' + E_MacNuggets.get() + "\n"
    'Mac Puff: \t\t\t\t\t\t' + E_MacPuff.get() + "\n"
    'Chicken Wings: \t\t\t\t\t\t' + E_ChickenWings.get() + "\n"
    'Coffee Cake: \t\t\t\t\t\t' + E_Coffee_Cake.get() + "\n"
    'Red Valet Cake: \t\t\t\t\t' + E_Red_Velvet_Cake.get() + "\n"
    'Black Forest Cake: \t\t\t\t\t' + E_Black_Forest.get() + "\n"
    'Boston Cream Cake: \t\t\t\t\t' + E_Boston_Cream_Cake.get() + "\n"
    'Latte: \t\t\t\t\t\t\t' + E_Latta.get() + "\n"
    'Coke: \t\t\t\t\t\t\t' + E_Coke.get() + "\n"
    'Pepsi: \t\t\t\t\t\t\t' + E_Pepsi.get() + "\n"
    'Cappuccino: \t\t\t\t\t\t' + E_Cappuccino.get() + "\n\n"
    'Cost of Food: \t\t\t\t\t\t' + CostofFood.get() + "\nTax Paid:\t\t\t\t\t\t" + PaidTax.get() + "\n"
    'Cost of Cakes and Drinks: \t\t\t\t' + CostofCakesandDrinks.get() + "\nSub Total:\t\t\t\t\t\t" + SubTotal.get() + "\n"
